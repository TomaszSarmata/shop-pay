...
export const sendEmail = (to, url, txt, subject, template) => {
  ...
  const mailOptions = {
    ...
    subject: subject,
    html: template(to, url), //to links with the to parameter in the SendEmail function at the top of this file which we get the value of by calling SendEmail in the signup.js (it will be email from the req.body that we get from the user input). The url links with the url param at the top of this file which we again pass the value in the signup.js (tokenised url)
  };
